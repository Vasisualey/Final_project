...
2. Пишем метод, в котором при помощи цикла проходимся по всем элементам массива, проверяем длину элемента и, если соблюдено условие задачи (<=3) то записываем результат во второй массив;
